        ...
        <div id={stayle.all} expand="lg" className="mr-auto my-2 my-lg-0">
          ...
          <div style={{ width: "46%" }}>
            <div className={stayle.dastur}>
              ...
              >
                va boshqa kurslarni taklif qilamiz.
              </span>
            </div>
              ...
              <Form>
                <InputGroup className="mb-3">
                  ...
                  <div className={stayle.sea}>
                    <i
                      class="fa fa-search"
                      style={{ paddingBottom: "35px", marginRight: "16px" }}
                      aria-hidden="true"
                    ></i>
                  </div>
                </InputGroup>
          ...
          >
            ...
            <Col>
              <div className={stayle.card4}>
                ...
                <div className={stayle.som4}>
                  250.000<span>UZS</span>
                </div>
                <div className={stayle.Sharx4}>
                  Shaxsiy biznersni rivojlantirishda e’tibor berish kerak
                  bo’lgan<span>|48 soat</span>
                </div>
                <div className={stayle.star1} style={{ display: "flex" }}>
                  <ReactStars
                    ...
                    activeColor="#ffd700"
                  />
                  <div className={stayle.tor1}>
                    4.1{" "}
                    <span
                      style={{ paddingTop: "-7px", backgroundColor: "white" }}
                    >
                      (560)
                    </span>
                  </div>
