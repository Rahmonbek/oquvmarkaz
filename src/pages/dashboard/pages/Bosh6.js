      ...
      <div>
        <div className={stayle5.all}>
          ...
          <div className={stayle5.cor} style={{ textAlign: "center" }}>
            <Carousel>
              <Carousel.Item>
                <img className="d-block w-100" src={oq} alt="First slide" />
          ...
          <div className={stayle5.brandLogo}>
            <Container>
              <div className={stayle5.title2}>Bizning hamkorlar</div>
              <div>
                <div className={stayle5.logo1}>
                  <img alt="BigCo Inc. logo" src={logo1} />{" "}
                </div>
                <div className={stayle5.logo2}>
                  <img alt="BigCo Inc. logo" src={logo2} />
                </div>
                <div className={stayle5.logo3}>
                  <img alt="BigCo Inc. logo" src={logo3} />
                </div>
                <div className={stayle5.logo4}>
                  <img alt="BigCo Inc. logo" src={logo4} />
                </div>{" "}
              </div>
            </Container>
          </div>
