...
export default function App() {
    ...
    let message;
    if(checked){
message=<Button  style={{margin:'24px 24px 24px 24px',}} variant="primary">sotib olish  | 250.000 uzs</Button>
    }
else{   
    message=<p> </p>
}
      ...
      <Accordion style={{backgroundColor:' #F1F2F6'}}>
        ...
        >
          <FormControlLabel
            ...
            control={<Checkbox onChange={e => setChecked(e.currentTarget.checked)} />}
